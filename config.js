...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94716159814")
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'Sandaru' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_NAME.split("@sandaruofficial")[1] === undefined ? 'King-Md' : process.env.PACK_NAME.split(";")[1],
